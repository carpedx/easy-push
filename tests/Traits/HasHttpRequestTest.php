...
namespace Carpedx\EasyPush\Tests\Traits;
...
class HasHttpRequestTest extends TestCase
{
    ...
    {
        $object = \Mockery::mock(DummyClassForHasHttpRequestTrait::class)->shouldAllowMockingProtectedMethods();
        ...
        $object->expects()->getHttpClient($mockBaseOptions)->andReturn($mockHttpClient)->once();
    ...
    {
        $object = \Mockery::mock(DummyClassForHasHttpRequestTrait::class)->makePartial()->shouldAllowMockingProtectedMethods();
        ...
        // timeout overwrite
        $object = \Mockery::mock(DummyTimeoutClassForHasHttpRequestTrait::class)->makePartial()->shouldAllowMockingProtectedMethods();
        $object->shouldReceive('getBaseOptions')->withAnyArgs()->passthru();
